...
module Phreak
  class Subparser
    ...
    # Prints all command names and descriptions defined on this subparser.
    def to_s(io : IO) : Nil
      indent = " " * 4
      command_min_width = 25
      description_pad = 15
      ...
      @bindings.each_index do |index|
        ...
        line = line.ljust command_min_width

        line += (indent + desc).rjust(description_pad)
